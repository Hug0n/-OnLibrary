		...
		<script>
			$(document).ready (function(){
				$('#btn-cadastrar').click(function(){
					...
					//SOBRENOME
					if($('#sobrenome').val() == ''){
						$('#sobrenome').css({'border-color': '#A94442'});		
						campo_vazio = true;
					} else {
					...
					//DATA DE NASCIMENTO
					if($('#nascimento').val() == ''){
						$('#nascimento').css({'border-color': '#A94442'});		
						campo_vazio = true;
					} else {
						$('#nascimento').css({'border-color': '#CCC'});
					}
					...
					//UF
					if($('#uf').val() == ''){
						$('#uf').css({'border-color': '#A94442'});		
						campo_vazio = true;
					} else {
						$('#uf').css({'border-color': '#CCC'});
					}

					//RUA
					if($('#rua').val() == ''){
						$('#rua').css({'border-color': '#A94442'});		
						campo_vazio = true;
					} else {
					...
					//COMPLEMENTO
					if($('#complemento').val() == ''){
						$('#complemento').css({'border-color': '#A94442'});		
						campo_vazio = true;
					} else {
						$('#complemento').css({'border-color': '#CCC'});
					}
					...
					//CELULAR
					if($('#celular').val() == ''){
						$('#celular').css({'border-color': '#A94442'});		
						campo_vazio = true;
					} else {
	...
	<body class="back-color">
		...
		<div class="container container-visual"> <!-- INÍCIO CONTAINER !-->
			<br />
			<form method="POST" action="class.registra_user.php" id="formCadastro">
				...
				<div class="row">
					...
					<div class="col-md-10 form-group">
						...
						<span class="padding-left span-test"> Sexo* <br/><input type="radio" class="padding-left" name="genero" value="M"> Homem* </span>
				...
				<div class="row"> <!-- ROW 2 - 1° coluna - Início !-->
					<div class="col-md-10"> 
						<h3> Endereço </h3>
						<hr>
						
						<span class="span-test"> Cidade* <br/><input type="text" class="form-control foorm-control-1" name="cidade" id="cidade"></span>
						<span class="padding-left span-test"> UF* <br/><input type="text" class="form-control foorm-control-0" name="uf" id="uf"></span>
						</p>
						<span class="span-test"> Rua* <br/><input type="text" class="form-control foorm-control-1" name="rua" id="rua"></span>

						<span class="padding-left span-test"> Bairro* <br/><input type="text" class="form-control foorm-control-1" name="bairro" id="bairro"></span>
				...
				<div class="row"> <!-- ROW 3 - 1° coluna - Início !-->
					<div class="col-md-10 row_2_marg_left_top">
						...
						<span class="padding-left span-test"> Celular* <br/><input type="text" class="form-control foorm-control-0-1" name="celular" id="celular"></span>
						</p>
